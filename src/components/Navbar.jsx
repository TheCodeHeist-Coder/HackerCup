...
const Navbar = () => {
  ...
  return (
    <div className="w-full  fixed top-0  z-50 px-4 md:px-10 lg:px-50 py-5">
      ...
      <div className="relative ">
        ...
        <div className="relative flex justify-between items-center h-16 px-6 md:px-10 rounded-full border border-red-600 bg-gray-950/70 backdrop-blur-2xl">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <h1 className="text-sm sm:text-lg md:text-xl tracking-wider font-light text-red-600">
              GDG HACKER CUP
            </h1>
          </div>
          ...
          <div className="hidden md:flex gap-10">
            {navLinks.map((link) => (
              <ScrollLink
                ...
                duration={500}
                offset={-70}
                className="cursor-pointer tracking-[3px] text-sm text-gray-100   hover:font-bold hover:scale-105  hover:text-red-600 font-normal transition-all duration-300"
              >
